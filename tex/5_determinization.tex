...
** Consider divide by 0.

\paragraph{Atomic mean operators.}
We introduce something called a mean operator for each distribution. We package the arithmetic used to compute each distribution's mean into an atomic target language construct:
\[
  \mathsf{mean}_D(e_1,\ldots,e_k).
\]


\[
\begin{aligned}
  \mathsf{mean}_{\mathsf{Uniform}}(e_1,e_2)
  &\quad\text{represents}\quad
  (e_1+e_2)\times 0.5,
  \\
  \mathsf{mean}_{\mathsf{Gaussian}}(e_1,e_2)
  &\quad\text{represents}\quad
  e_1,
  \\
  \mathsf{mean}_{\mathsf{Beta}}(e_1,e_2)
  &\quad\text{represents}\quad
  e_1/(e_1+e_2),
  \\
  \mathsf{mean}_{\mathsf{Poisson}}(e)
  &\quad\text{represents}\quad
  e,
  \\
  \mathsf{mean}_{\mathsf{Gamma}}(e_1,e_2)
  &\quad\text{represents}\quad
  e_1/e_2,
  \\
  \mathsf{mean}_{\mathsf{Exponential}}(e)
  &\quad\text{represents}\quad
  1/e.
\end{aligned}
\]

**The reason behind this becomes clear in the soundness proof, specifically for the expected interpretation of the symbolic semantics.
...
\begin{figure}[t]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}m{0.33\textwidth}
    ...
    \toprule
    \toprule
    \textbf{$e:\tau$} & \textbf{Condition} & \textbf{$\exptrans{e : \tau} : \tau$} \\
    \midrule
    %
    $x : \tau$  & 
    -- &
    ...
    \begin{tabular}[c]{@{}l@{}}
      ...
      $m_3 = \G$
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $((\exptrans{e_1 : \Float{m_1}} + \exptrans{e_2 : \Float{m_2}}) \times 0.5 : \Float{\E}) : \Float{m_3}$ \\
      $\uniform(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    %
    ...
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      ...
      $\gaussian(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $(\exptrans{e_1 : \Float{m_1}}\; /\; (\exptrans{e_1 : \Float{m_1}} + \exptrans{e_2 : \Float{m_2}})) : \Float{m_3}$ \\
      $\betafn(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\exptrans{e_1 : \Float{m_1}}$ \\
      $\poisson(\exptrans{e_1 : \Float{m_1}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $(\exptrans{e_1 : \Float{m_1}}\; /\; \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$ \\
      $\gammafn(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $(1 : \Float{\E}\; /\; \exptrans{e_1 : \Float{m_1}}) : \Float{m_3}$ \\
      $\exponential(\exptrans{e_1 : \Float{m_1}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    -- &
    $(\exptrans{e_1 : \Float{m_1}} \times \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$ \\
    \midrule
    %
    $(e_1 : \Float{m_1}\; /\; e_2 : \Float{m_2}) : \Float{m_3}$ &
    -- &
    ...
    -- &
    $(\ifkw\ \exptrans{b : \Bool}\ \thenkw\ \exptrans{e_1 : \tau}\ \elsekw\ \exptrans{e_2 : \tau}) : \tau$ \\
    %
    \midrule
    $(\letkw\ x = e_1 : \tau_1\ \inkw\ e_2 : \tau_2) : \tau_2$ &
    -- &
    $(\letkw\ x = \exptrans{e_1 : \tau_1}\ \inkw\ \exptrans{e_2 : \tau_2}) : \tau_2$
    \\
    \bottomrule
    \bottomrule
  \end{tabular}
...
\begin{figure}[t]
  ...
  \begin{tabular}{@{}>{\raggedright\arraybackslash}m{0.33\textwidth}
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\mathsf{mean}_{\mathsf{Uniform}}(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$ \\
      $\uniform(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\mathsf{mean}_{\mathsf{Gaussian}}(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$ \\
      $\gaussian(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\mathsf{mean}_{\mathsf{Beta}}(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$ \\
      $\betafn(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\mathsf{mean}_{\mathsf{Poisson}}(\exptrans{e_1 : \Float{m_1}}) : \Float{m_2}$ \\
      $\poisson(\exptrans{e_1 : \Float{m_1}}) : \Float{m_2}$
    \end{tabular} \\
    \midrule
    %
    $\gammafn(e_1 : \Float{m_1}, e_2 : \Float{m_2}) : \Float{m_3}$ &
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\mathsf{mean}_{\mathsf{Gamma}}(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$ \\
      $\gammafn(\exptrans{e_1 : \Float{m_1}}, \exptrans{e_2 : \Float{m_2}}) : \Float{m_3}$
    \end{tabular} \\
    \midrule
    %
    ...
    \end{tabular} &
    \begin{tabular}[c]{@{}>{\raggedright\arraybackslash}p{0.43\textwidth}@{}}
      $\mathsf{mean}_{\mathsf{Exponential}}(\exptrans{e_1 : \Float{m_1}}) : \Float{m_2}$ \\
      $\exponential(\exptrans{e_1 : \Float{m_1}}) : \Float{m_2}$
    \end{tabular} \\
    \midrule
    %
    $(e_1 : \Float{m_1} + e_2 : \Float{m_2}) : \Float{m_3}$ &
  ...
  \end{tabular}
  \end{adjustbox}
  \caption{Determinization function (NEW; REFER TO THIS). We case split only on the modes that affect $\exptrans{\cdot}$; all other float modes are independent and may range over $\E$ and $\G$. Note, expanding the mean operator produces exactly the old table.}
  \label{fig:determinization}
\end{figure}
