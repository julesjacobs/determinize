...
\begin{mathpar}
  ...
  \inferrule[\textsc{Mul}]
    {\Gamma \vdash e_1 : \Float{m_1} \mid C_1 \\ \Gamma \vdash e_2 : \Float{m_2} \mid C_2}
    {\Gamma \vdash e_1 \times e_2 : \Float{\alpha} \mid C_1, C_2, m_1 \preceq \G, m_2 \preceq \alpha}
  \and
  \inferrule[\textsc{Div}]
    {\Gamma \vdash e_1 : \Float{m_1} \mid C_1 \\ \Gamma \vdash e_2 : \Float{m_2} \mid C_2}
    {\Gamma \vdash e_1\; /\; e_2 : \Float{\alpha} \mid C_1, C_2, m_1 \preceq \alpha, m_2 \preceq \G}
  \and
  \inferrule[\textsc{Cmp}]
    {\Gamma \vdash e_1 : \Float{m_1} \mid C_1 \\ \Gamma \vdash e_2 : \Float{m_2} \mid C_2}
...
\begin{example}
  exponential(uniform(0,1)*uniform(0,2))
\end{example}
...
\begin{example}
  ...
  \begin{align*}
      ...
      \alpha_6 \preceq \G &, \alpha_9 \preceq \alpha_{10} \\
...
\begin{example}
  ...
  \begin{align*}
    \theta = [&\alpha_1 \mapsto \E,\ \alpha_2 \mapsto \E,\ \alpha_3 \mapsto \E,\ \alpha_4 \mapsto \G,\ \alpha_5 \mapsto \E, \\
              &\alpha_6 \mapsto \G,\ \alpha_7 \mapsto \G,\ \alpha_8 \mapsto \G,\ \alpha_9 \mapsto \E,\ \alpha_{10} \mapsto \E,\ \alpha_{11} \mapsto \E ].
  \end{align*}
  In particular, the program is assigned type $\Float{\E}$.
\end{example}
