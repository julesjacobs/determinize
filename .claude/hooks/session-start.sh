...
echo "Toolchain on PATH right now: $(have node) $(have latexmk) $(have lake) $(have python3) $(have direnv) $(have nix)"
echo "Missing tools are reachable via 'direnv exec <dir> CMD' or 'nix develop .#<lean|sim|tex> --command CMD' (see CLAUDE.md)."
